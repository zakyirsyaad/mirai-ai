...
mode, expiry, and the 14-post limit. Ask for explicit approval if the user has
not already approved in this message. Only after explicit approval, call
`mirai_start_autopost` with `approved=true`.
