...
8. Before posting, summarize connected account, campaign mode, expiry, 14-post limit, and active content policy.
9. Call `mirai_start_autopost` with `approved=true` only after explicit user approval.
